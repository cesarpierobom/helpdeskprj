    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card card-default">
                <div class="card-header text-center">Editar Organização</div>
                <div class="card-body">
                    <form id="formEditarOrganizacao" accept-charset="utf-8">
                    <input type="hidden" name="id" id="id" value="{{$organizacao->id}}" placeholder="">
...
<script src="{{ URL::asset('js/organizacao/edit.js') }}" defer></script>
@endsection
