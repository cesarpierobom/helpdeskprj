        ...
        <div class="col-md-10 ">
            <div class="card card-default">
                <div class="card-header text-center">
                    Grupos de Usuario
                    <a class="btn btn-sm btn-success float-right" href="{{route('usuario_grupo.create')}}">Cadastrar</a>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form id="formBuscarUsuarioGrupo" accept-charset="utf-8">
                                <div class="form-row">
...
<script src="{{ URL::asset('js/usuario_grupo/index.js') }}" defer></script>
@endsection