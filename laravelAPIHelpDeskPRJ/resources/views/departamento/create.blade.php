    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card card-default">
                <div class="card-header text-center">Cadastrar Departamentos</div>
                <div class="card-body">
                    <form id="formCadastrarDepartamento" accept-charset="utf-8">
...
<script src="{{ URL::asset('js/departamento/create.js') }}" defer></script>
@endsection