        ...
        <div class="col-md-10 ">
            <div class="card card-default">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form id="formBuscarDepartamento" accept-charset="utf-8">
                                <div class="form-row">
                    ...
                    <div class="row" style="margin-top: 5%">
                        <div class="col-md-12">
                            <table id="resultado_departamento" class="table table-responsive-sm table-responsive-md table-responsive-lg">
                            </table>
                        </div>
                    </div>
                </div>
...
<script src="{{ URL::asset('js/departamento/index.js') }}" defer></script>
@endsection