    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card card-default">
                <div class="card-header text-center">Cadastrar Feedback de Chamados</div>
                <div class="card-body">
                    <form id="formCadastrarFeedbackChamado" accept-charset="utf-8">
...
<script src="{{ URL::asset('js/chamado_feedback/create.js') }}" defer></script>
@endsection