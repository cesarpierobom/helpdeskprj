        ...
        <div class="col-md-10 ">
            <div class="card card-default">
                <div class="card-header text-center">
                    Grupos de Suporte
                    <a class="btn btn-sm btn-success float-right" href="{{route('suporte_grupo.create')}}">Cadastrar</a>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row" style="margin-top: 5%">
                        <div class="col-md-12">
                            <table id="resultado_suporte_grupo" class="table table-responsive-sm table-responsive-md table-responsive-lg">
                            </table>
                        </div>
                    </div>
                </div>
...
<script src="{{ URL::asset('js/suporte_grupo/index.js') }}" defer></script>
@endsection