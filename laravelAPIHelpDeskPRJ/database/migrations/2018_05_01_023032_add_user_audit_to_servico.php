...
class AddUserAuditToServico extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('servico', function (Blueprint $table) {
            $table->dropForeign("servico_create_user_id_foreign");
            $table->dropColumn('create_user_id');
            $table->dropForeign("servico_update_user_id_foreign");
            $table->dropColumn('update_user_id');
            $table->dropForeign("servico_delete_user_id_foreign");
