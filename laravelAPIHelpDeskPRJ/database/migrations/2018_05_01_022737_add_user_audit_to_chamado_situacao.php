...
class AddUserAuditToChamadoSituacao extends Migration
{
    ...
    {
        Schema::table('chamado_situacao', function (Blueprint $table) {
            $table->dropForeign("chamado_situacao_create_user_id_foreign");
            $table->dropColumn('create_user_id');
            $table->dropForeign("chamado_situacao_update_user_id_foreign");
            $table->dropColumn('update_user_id');
            $table->dropForeign("chamado_situacao_delete_user_id_foreign");
