...
class AddUserAuditToOrganizacaoUsuario extends Migration
{
    ...
    {
        Schema::table('organizacao_usuario', function (Blueprint $table) {
            $table->dropForeign("organizacao_usuario_create_user_foreign");
            $table->dropColumn('create_user');
            $table->dropForeign("organizacao_usuario_update_user_foreign");
            $table->dropColumn('update_user');
            $table->dropForeign("organizacao_usuario_delete_user_foreign");
