...
class AddUserAuditToUsuarioGrupo extends Migration
{
    ...
    {
        Schema::table('usuario_grupo', function (Blueprint $table) {
            $table->dropForeign("usuario_grupo_create_user_foreign");
            $table->dropColumn('create_user');
            $table->dropForeign("usuario_grupo_update_user_foreign");
            $table->dropColumn('update_user');
            $table->dropForeign("usuario_grupo_delete_user_foreign");
