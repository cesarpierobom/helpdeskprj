...
class AddUserAuditToChamadoFeedback extends Migration
{
    ...
    {
        Schema::table('chamado_feedback', function (Blueprint $table) {
            $table->dropForeign("chamado_feedback_create_user_foreign");
            $table->dropColumn('create_user');
            $table->dropForeign("chamado_feedback_update_user_foreign");
            $table->dropColumn('update_user');
            $table->dropForeign("chamado_feedback_delete_user_foreign");
