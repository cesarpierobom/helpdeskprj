...
class AddUserAuditToUsers extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('users', function (Blueprint $table) {
            $table->dropForeign("users_create_user_id_foreign");
            $table->dropColumn('create_user_id');
            $table->dropForeign("users_update_user_id_foreign");
            $table->dropColumn('update_user_id');
            $table->dropForeign("users_delete_user_id_foreign");
