...
class AddUserAuditToChamadoCategoria extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('chamado_categoria', function (Blueprint $table) {
    ...
    {
        Schema::table('chamado_categoria', function (Blueprint $table) {
            $table->dropForeign("chamado_categoria_create_user_id_foreign");
            $table->dropColumn('create_user_id');
            $table->dropForeign("chamado_categoria_update_user_id_foreign");
            $table->dropColumn('update_user_id');
            $table->dropForeign("chamado_categoria_delete_user_id_foreign");
