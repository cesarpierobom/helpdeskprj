...
class AddUserAuditToChamadoCategoria extends Migration
{
    ...
    {
        Schema::table('chamado_categoria', function (Blueprint $table) {
            $table->dropForeign("chamado_categoria_create_user_foreign");
            $table->dropColumn('create_user');
            $table->dropForeign("chamado_categoria_update_user_foreign");
            $table->dropColumn('update_user');
            $table->dropForeign("chamado_categoria_delete_user_foreign");
